...
public final class ANumeroExpPrimaria extends PExpPrimaria
{
    private TNumero _numero_;

    public ANumeroExpPrimaria()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseANumeroExpPrimaria(this);
    }
