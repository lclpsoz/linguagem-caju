...
public final class AChamadaExpPrimaria extends PExpPrimaria
{
    private PChamada _chamada_;

    public AChamadaExpPrimaria()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AChamadaExpPrimaria(
    ...
    {
        ((Analysis) sw).caseAChamadaExpPrimaria(this);
    }
